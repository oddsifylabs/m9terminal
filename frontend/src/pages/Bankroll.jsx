...
const Bankroll = ({ setActiveMenu }) => {
  ...
  // Risk Allocation - MLB ONLY
  const riskAllocation = {
    totalRisk: 7650,
    bySession: [
      { sessionId: 'S_001', date: '2024-06-01', allocation: 2500, percentOfBank: 5.0, status: 'active', sport: 'MLB' },
      { sessionId: 'S_002', date: '2024-06-01', allocation: 1800, percentOfBank: 3.6, status: 'active', sport: 'MLB' },
      { sessionId: 'S_003', date: '2024-05-31', allocation: 1200, percentOfBank: 2.4, status: 'active', sport: 'MLB' },
      { sessionId: 'S_004', date: '2024-05-30', allocation: 900, percentOfBank: 1.8, status: 'paused', sport: 'MLB' },
      { sessionId: 'S_005', date: '2024-05-30', allocation: 250, percentOfBank: 0.5, status: 'closed', sport: 'MLB' },
    ],
    limits: {
  ...
  const activeSessions = [
    {
      ...
      notes: 'Strong signals from sharp money on NYY -1.5',
      confidence: 85,
    },
    {
      id: 'S_002',
      ...
      notes: 'Volume anomaly detected on HOU vs LAA total',
      confidence: 72,
    },
  ];
    ...
    <div className="min-h-screen bg-white text-gray-900 pb-20">
      ...
      <div className="bg-blue-50 border-b border-blue-200 px-4 py-3">
        <p className="text-sm text-blue-800">
          <strong>⚾ MLB Model Only:</strong> All data shown is for MLB trades only. Other sports coming soon.
        </p>
      </div>
      ...
      <div className="px-4 py-6 max-w-6xl mx-auto">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <p className="text-sm text-gray-600 font-medium">Active Risk (MLB)</p>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <p className="text-sm text-gray-600 font-medium">MLB ROI</p>
                <p className="text-3xl font-bold text-green-600 mt-2">
                  {bankrollData.roi}%
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-green-50 to-white border border-green-200 rounded-lg p-6">
                <p className="text-sm text-gray-600 font-medium">Total MLB Sessions</p>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-white border border-blue-200 rounded-lg p-6">
                <p className="text-sm text-gray-600 font-medium">Active MLB Sessions</p>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-white border border-purple-200 rounded-lg p-6">
                <p className="text-sm text-gray-600 font-medium">MLB Win Rate</p>
                <p className="text-4xl font-bold text-purple-700 mt-2">60.0%</p>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'allocation' && (
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-bold text-gray-900 mb-4">MLB Risk Allocation</h3>
            ...
            {/* Limits */}
            <div>
              <h3 className="text-lg font-bold text-gray-900 mb-4">MLB Betting Limits</h3>
        ...
        {activeTab === 'performance' && (
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-gray-900">MLB Performance</h3>
        ...
        {activeTab === 'sessions' && (
          <div className="space-y-6">
            <h3 className="text-lg font-bold text-gray-900">Active MLB Sessions</h3>
            <div className="space-y-4">
